...
def main():
    ...
    try:
        ...
        print(f"🎉 Success!")
        print(f"🎉 SQL file ./{OUTPUT_FILE} has been generated with {CONFIG['num_products']} products and {len(order_totals)} orders.")
        
        # copy the output file to the standard output file
        shutil.copy(OUTPUT_FILE, STD_OUTPUT_FILE)
        print(f"🎉 SQL file ./{STD_OUTPUT_FILE} has been copied from ./{OUTPUT_FILE}.")
