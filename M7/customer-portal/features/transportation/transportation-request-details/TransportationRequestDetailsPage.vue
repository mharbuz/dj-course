<template>
  <div>
    ...
    <div v-else-if="request" class="space-y-8">
      <TransportationDetailsOverview :request="request" />
      <TransportationDetailsRoute :request="request" />
      <TransportationDetailsCargo :request="request" />
      <TransportationDetailsTimeline :request="request" />
      <TransportationDetailsPricing :request="request" />
    </div>
...
import { useTransportationRequestDetails } from './transportation-request-details-api'
import TransportationDetailsHeader from './TransportationDetailsHeader.vue'
import TransportationDetailsOverview from './TransportationDetailsOverview.vue'
import TransportationDetailsRoute from './TransportationDetailsRoute.vue'
import TransportationDetailsCargo from './TransportationDetailsCargo.vue'
import TransportationDetailsTimeline from './TransportationDetailsTimeline.vue'
import TransportationDetailsPricing from './TransportationDetailsPricing.vue'
